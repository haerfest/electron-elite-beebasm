...
build:
	...
	echo _PAGING_WORKAROUND=$(paging-workaround) >> 1-source-files/main-sources/elite-build-options.asm
	echo _MAXED_OUT=$(maxed_out) >> 1-source-files/main-sources/elite-build-options.asm
	...
	$(BEEBASM) -i 1-source-files/main-sources/elite-disc.asm -do 5-compiled-game-discs/elite-electron-flicker-free-swram$(suffix-electron).ssd -opt 3 -title "E L I T E"
